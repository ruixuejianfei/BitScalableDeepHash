...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
	...
	} else if (type == "elewise_product") {
			return new ElementWiseProductLayer<Dtype>(param);
	} else if (type == "euclidean_loss") {
		return new EuclideanLossLayer<Dtype>(param);
	} else if (type == "euclidean_triplet_loss") {
		return new EuclideanTripletLossLayer<Dtype>(param);
